  ...
  return (
    <>
      ...
      <Panel position="top-left" className="flex items-center gap-3 mt-4 ml-4">
        <button 
          onClick={onBack} 
          className="w-10 h-10 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg shadow-sm flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-slate-700 hover:text-gray-900 dark:hover:text-white transition-colors"
        ...
        <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border border-gray-200 dark:border-slate-700 rounded-lg shadow-sm px-4 py-2 flex items-center gap-2">
          ...
          <span className="font-semibold text-gray-800 dark:text-gray-200 truncate max-w-[100px] sm:max-w-[200px]">{workflowName}</span>
        </div>
        { (isSaving || hasUnsavedChanges) && (
          <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border border-gray-200 dark:border-slate-700 rounded-lg shadow-sm px-3 py-2 flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
            {isSaving ? (
              <>
        ...
        <button 
          ...
          className={cn(
            ...
            showMiniMap 
              ...
              : 'bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-slate-700 hover:text-gray-900 dark:hover:text-white'
          )}
      ...
      <Panel position="top-right" className="flex flex-col gap-2 mt-4 mr-4">
        ...
        <button 
          onClick={onSave}
          disabled={isSaving}
          className="w-10 h-10 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg shadow-sm flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-slate-700 hover:text-gray-900 dark:hover:text-white transition-colors disabled:opacity-50"
